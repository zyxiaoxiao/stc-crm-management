...
const tableList = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable1",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList2 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable2",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList22 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable22",
	//表格工具栏
	tableToolbar: {
		right: false
	},
...
const tableList3 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable3",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList33 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable33",
	//表格工具栏
	tableToolbar: {
		right: false
	},
...
const tableList4 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable4",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList5 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable5",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList6 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable6",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList7 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable7",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList8 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable8",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//请求属性设置
	httpAttribute: {
...
const tableList9 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable9",
	//面初始化渲染完成 是否调请求
	isRequest: true,
...
const tableList10 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable10",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//请求属性设置
	httpAttribute: {
...
const tableList11 = reactive({
	id: "/customerManage/customerManagement/custInfo_user_public.vue_zTable11",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//请求属性设置
	httpAttribute: {
