<template>
	<div class="all-height flex-column main-card">
		<el-tabs class="flex-column flex-1 main-card-tabs" v-model="tabPaneName" @tab-change="tabChange">
			<el-tab-pane
				title1="个人客户信息查询"
				:label="$t('corpinfopanelpersonalCustomerInformationQuerytitle')"
			...
			<el-tab-pane
				title1="个人客户信息废弃查询"
				:label="$t('corpinfopanelpersonalCustomerInformationQuerytitlediscarded')"
				class="main-tab-pane-content all-height flex-column"
				name="1"
			>
...
import custInfouser from "./custInfo_user.vue";
...
const tableList1 = reactive({
	id: "/customerManage/customerManagement/myCustomers.vue_zTable1",
	//请求属性设置
	httpAttribute: {
		url: "/mylims/enterpriseinfo/enterpriseinfo!selectCustomerForMyCustomerNew.action",
		root: "enterpriseInfos",
		baseParams: {
			"cond.auditflag": "2",
			"cond.newcustomtype": "SE",
			"cond.discardflag": "0",
			"cond.ascription_my_customer": "Y"
		}
	},
	//表格表头
	tableColumns: [
...
const tableList2 = reactive({
	id: "/customerManage/customerManagement/myCustomers.vue_zTable2",
	//请求属性设置
	httpAttribute: {
		url: "/mylims/enterpriseinfo/enterpriseinfo!selectCustomerForMyCustomerNew.action",
		root: "enterpriseInfos",
