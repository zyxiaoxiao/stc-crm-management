...
import companydetailbgreadonly from "./company_detail_bg_readonly.vue";
import companydetailnewhistoryreadonly from "./company_detail_new_history_readonly.vue";
...
const props = defineProps({
	condobj: {
		...
		corpid: "", //原客户id
		corpbgid: "", //变更客户id
		filterStatus: "" //过滤状态，初始化时判断执行那些代码，用于一个界面多用时
	}
});
...
const tableList = reactive({
	id: "/customerManage/customerReadonly/company_detail_bg_readonly.vue_zTable1",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList2 = reactive({
	id: "/customerManage/customerReadonly/company_detail_bg_readonly.vue_zTable2",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList22 = reactive({
	id: "/customerManage/customerReadonly/company_detail_bg_readonly.vue_zTable22",
	//表格工具栏
	tableToolbar: {
		right: false
	},
...
const tableList3 = reactive({
	id: "/customerManage/customerReadonly/company_detail_bg_readonly.vue_zTable3",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList33 = reactive({
	id: "/customerManage/customerReadonly/company_detail_bg_readonly.vue_zTable33",
	//表格工具栏
	tableToolbar: {
		right: false
	},
...
const tableList4 = reactive({
	id: "/customerManage/customerReadonly/company_detail_bg_readonly.vue_zTable4",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList6 = reactive({
	id: "/customerManage/customerReadonly/company_detail_bg_readonly.vue_zTable6",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList7 = reactive({
	id: "/customerManage/customerReadonly/company_detail_bg_readonly.vue_zTable7",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
