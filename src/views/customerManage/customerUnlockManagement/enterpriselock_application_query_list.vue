...
const tableList1 = reactive({
	id: "/customerManage/customerUnlockManagement/enterpriselock_application_query_list.vue_zTable1",
	//请求属性设置
	httpAttribute: {
...
const tableList2 = reactive({
	id: "/customerManage/customerUnlockManagement/enterpriselock_application_query_list.vue_zTable2",
	//请求属性设置
	httpAttribute: {
