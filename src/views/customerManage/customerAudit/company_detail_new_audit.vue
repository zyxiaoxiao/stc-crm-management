	...
	<div class="all-height flex-column">
		<div style="margin: 10px; text-align: right">
			...
			<el-button
				...
				icon="Check"
				plain
				@click="auditAction('/mylims/enterpriseinfo/enterpriseinfo!approve.action', 'Approve !')"
			...
			<el-button
				...
				icon="Close"
				plain
				@click="auditAction('/mylims/enterpriseinfo/enterpriseinfo!reject.action', 'Reject !')"
			...
			<el-button
				...
				icon="Close"
				plain
				@click="auditAction('/mylims/enterpriseinfo/enterpriseinfo!reject2Submitor.action', 'Reject !')"
					...
					<el-row :gutter="15" class="main-align-items-center">
						<el-col :span="6">
							<el-form-item title1="旧客户号" :label="$t('fieldcolumncustomercodeold')">
								<el-input type="text" v-model.trim="formData.corpnofirst" />
							</el-form-item>
						</el-col>
						<el-col :span="6">
							<el-form-item>
								<el-input type="text" v-model.trim="formData.corpnolast" />
							</el-form-item>
						</el-col>
					</el-row>
					<el-row :gutter="15" class="main-align-items-center">
...
const saveEnterpriseInfo = async () => {
	...
	const res = await http.post("/mylims/enterpriseinfo/enterpriseinfo!saveAuditEnterpriseInfo.action", qs.stringify(params));
	if (res) {
...
const tableList = reactive({
	id: "/customerManage/customerAudit/company_detail_new_audit.vue_zTable1",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList2 = reactive({
	id: "/customerManage/customerAudit/company_detail_new_audit.vue_zTable2",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList22 = reactive({
	id: "/customerManage/customerAudit/company_detail_new_audit.vue_zTable22",
	//表格工具栏
	tableToolbar: {
		right: false
	},
...
const tableList3 = reactive({
	id: "/customerManage/customerAudit/company_detail_new_audit.vue_zTable3",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList33 = reactive({
	id: "/customerManage/customerAudit/company_detail_new_audit.vue_zTable33",
	//表格工具栏
	tableToolbar: {
		right: false
	},
...
const tableList4 = reactive({
	id: "/customerManage/customerAudit/company_detail_new_audit.vue_zTable4",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList5 = reactive({
	id: "/customerManage/customerAudit/company_detail_new_audit.vue_zTable5",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
