	...
	<div class="all-height flex-column">
		<div style="margin: 10px; text-align: right">
			...
			<el-button
				...
				icon="Check"
				plain
				@click="auditAction('/mylims/enterpriseinfo/enterpriseinfo!approvebg.action', 'Approve !')"
			...
			<el-button
				...
				icon="Close"
				plain
				@click="auditAction('/mylims/enterpriseinfo/enterpriseinfo!rejectbg.action', 'Reject !')"
			...
			<el-button
				...
				icon="Close"
				plain
				@click="auditAction('/mylims/enterpriseinfo/enterpriseinfo!rejectbg2Submitor.action', 'Reject !')"
		...
		>
			...
			<el-tab-pane
				...
				:name="1"
			>
				<zTable v-if="tabPaneXR.get(1)" ref="zTable1" :tableList="tableList" @link-detailbg="downloadfiles"> </zTable>
			</el-tab-pane>
			<el-tab-pane
				title1="客户联系人信息"
				...
				:name="2"
			>
				<zTable v-if="tabPaneXR.get(2)" ref="zTable2" :tableList="tableList2" @current-change="currentChangeContact"> </zTable>
			...
			<el-tab-pane
				...
				:name="3"
			>
				<zTable v-if="tabPaneXR.get(3)" ref="zTable3" :tableList="tableList3" @current-change="currentChangeAddress"> </zTable>
				<el-divider content-position="left" style="margin: 0px; margin-top: 10px; border-width: 3px"></el-divider>
			...
			<el-tab-pane
				...
				:name="4"
			>
				<zTable v-if="tabPaneXR.get(4)" ref="zTable4" :tableList="tableList4" @link-detailbg="downloadAccountfiles"> </zTable>
			</el-tab-pane>
			<el-tab-pane
				title1="归属信息"
			...
			<el-tab-pane
				...
				:name="6"
			>
				<zTable v-if="tabPaneXR.get(6)" ref="zTable7" :tableList="tableList7">
					<!-- 表格操作 -->
...
const tableList = reactive({
	id: "/customerManage/customerAudit/company_detail_bg_audit.vue_zTable1",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList2 = reactive({
	id: "/customerManage/customerAudit/company_detail_bg_audit.vue_zTable2",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList22 = reactive({
	id: "/customerManage/customerAudit/company_detail_bg_audit.vue_zTable22",
	//表格工具栏
	tableToolbar: {
		right: false
	},
...
const tableList3 = reactive({
	id: "/customerManage/customerAudit/company_detail_bg_audit.vue_zTable3",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList33 = reactive({
	id: "/customerManage/customerAudit/company_detail_bg_audit.vue_zTable33",
	//表格工具栏
	tableToolbar: {
		right: false
	},
...
const tableList4 = reactive({
	id: "/customerManage/customerAudit/company_detail_bg_audit.vue_zTable4",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList6 = reactive({
	id: "/customerManage/customerAudit/company_detail_bg_audit.vue_zTable6",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tableList7 = reactive({
	id: "/customerManage/customerAudit/company_detail_bg_audit.vue_zTable7",
	//面初始化渲染完成 是否调请求
	isRequest: true,
	//表格工具栏
	tableToolbar: {
...
const tabChange = TabPaneName => {
	...
	if (formData.corpbgid) {
		switch (TabPaneName) {
			...
			case 6:
				// 历史变更查询
				if (props.condobj.filterStatus != "1") {
					if (!tabPaneXR.get(TabPaneName)) tabPaneXR.set(TabPaneName, true); // 第一次才渲染
				}
				break;
		}
