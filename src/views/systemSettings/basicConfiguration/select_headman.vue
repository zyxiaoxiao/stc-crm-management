...
const tableList1 = reactive({
	id: "/systemSettings/basicConfiguration/select_headman.vue_zTable1",
	isRadio: true, //设置为单选
	//请求属性设置
	httpAttribute: {
		url: "/core/user/user!selectUserInfoByCondNormal.action",
		root: "userInfos",
		baseParams: { "cond.islocal": "0" }
	},
	//表格表头
	tableColumns: [
		{
		...
		{
			title: "中文名称",
			label: "itemtitlebase_useruserdesc_cn",
			prop: "userdesc_cn",
			type: "Input",
			width: "160"
		},
