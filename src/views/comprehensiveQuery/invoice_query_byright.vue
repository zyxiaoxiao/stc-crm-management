<template>
	<div class="all-height flex-column main-card">
		<el-tabs class="flex-column flex-1 main-card-tabs" v-model="tableTabsValue" @tab-change="tabChange">
			...
			<el-tab-pane
				class="main-tab-pane-content all-height flex-column"
				:label="$t('columninvoiceTax_ticket_abnormal_information_query')"
				title1="开票异常信息查询"
...
const invoicetableList = reactive({
	id: "/comprehensiveQuery/invoice_query_byright.vue_grid_invoiceInfos",
	//请求属性设置
	httpAttribute: {
...
const htableList = reactive({
	id: "/comprehensiveQuery/invoice_query_byright.vue_grid_invoiceInfosquery",
	//请求属性设置
	httpAttribute: {
		url: "/crm/invoice/invoice!selectAbnormalInvoiceInfo.action",
		root: "invoiceInfos",
		baseParams: {
			"cond.auditflag1": "0"
		}
