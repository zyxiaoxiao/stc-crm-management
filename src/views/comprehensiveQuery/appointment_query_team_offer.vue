	...
	<div class="all-height flex-column main-card">
		<el-tabs class="flex-column flex-1 main-card-tabs" v-model="tableTabsValue" @tab-change="tabChange">
			<el-tab-pane
				...
				:label="$t('menubaseTeamofferquery')"
				title1="小组报价查询"
				name="query"
			>
				<zTable
...
const tableTabsValue = ref("query");
...
const atableList = reactive({
	id: "/comprehensiveQuery/appointment_query_team_offer.vue_grid_appointmentInfosQuery",
	//请求属性设置
	httpAttribute: {
		url: "/mylims/order/appointment!selectAppointmentInfoGroupByCond.action",
