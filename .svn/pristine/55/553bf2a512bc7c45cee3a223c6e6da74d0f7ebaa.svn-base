<template>
	<div class="all-height flex-column">
		...
		>
			<el-tab-pane :label="$t('menubasequotationapp')" name="info">
				<div style="margin: 10px; text-align: left">
					<el-button size="small" class="button_show" v-show="isbtnShow" type="primary" icon="Download" plain>{{
						$t("menu_downAppointment")
					}}</el-button>
					<el-button size="small" class="button_show" v-show="isbtnShow" type="primary" icon="Position" plain>{{
						$t("menu_sendAppointment")
					}}</el-button>
					<el-button size="small" class="button_show" v-show="historyappShow" type="primary" icon="Search" plain>{{
						$t("menu_historyapp")
					}}</el-button>
					<el-button
						size="small"
						...
						icon="Document"
						plain
						@click="dialogShow('dialogShow_customerListQuery')"
					...
					<el-button size="small" class="button_show" v-show="isbtnShow" type="info" icon="ArrowLeft" plain>{{
						$t("SRM_btnPrevious")
					}}</el-button>
					<el-button
						size="small"
				...
				<el-form style="margin: 0px 15px" label-position="right" label-width="120px" :model="formData" :rules="rules">
					<el-divider content-position="left">{{ $t("menubasewtjy") }}</el-divider>
					<el-row class="main-align-items-center">
						<el-col :span="12">
							<el-form-item :label="$t('crmcolumnreservnum') + ':'" title1="报价单号" prop="reservnum">
								<el-input type="text" readonly v-model="formData.reservnum"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item :label="$t('crmcolumnwsp') + ':'" title1="是否分包" prop="desc90">
								<el-select
					...
					<el-row class="main-align-items-center">
						...
						<el-col :span="0">
							...
							<el-form-item prop="addressremark">
								<el-input type="text" clearable v-model="formData.addressremark" title1="付款单位地址详细信息"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item :label="$t('paymentnoticepaymentunitcode') + ':'" title1="付款单位编码" prop="enterprisecode">
								<el-input type="text" clearable v-model="formData.enterprisecode" readonly></el-input>
							</el-form-item>
						</el-col>

						<el-col :span="12">
							<el-form-item :label="$t('columnappointmentdiscount') + ':'" title1="付款单位折扣" prop="desc80">
						...
						<el-col :span="12">
							<el-form-item :label="$t('columnAddress') + ':'" title1="付款单位地址" prop="paymentaddress">
						...
						<el-col :span="12">
							<el-form-item :label="$t('columnContactPerson')" title1="付款单位联系人" prop="billingcontact">
					...
					<el-row class="main-align-items-center">
						<el-col :span="12">
							<el-form-item :label="$t('itemtitleworkflowdefcorpdesc') + ':'" title1="单位名称" prop="desc1">
						...
						<el-col :span="0">
							<el-form-item prop="desc2" title1="单位ID">
								<el-input type="text" clearable v-model="formData.desc2"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item :label="$t('itemtitlebase_flowcorpcode') + ':'" title1="单位编码" prop="desc3" readonly>
								<el-input type="text" clearable v-model="formData.desc3"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item :label="$t('columnappointmentdiscount') + ':'" title1="单位折扣" prop="desc4" readonly>
								<el-input type="text" clearable v-model="formData.desc4"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item :label="$t('i18ncrmcontractpaymentmethod') + ':'" title1="付款方式" prop="desc5">
								<el-select
					...
					<el-row class="main-align-items-center">
						<el-col :span="12">
							<el-form-item :label="$t('itemtitlereportzh') + ':'" title1="报告中文抬头" prop="report_zh">
						...
						<el-col :span="12">
							<el-form-item :label="$t('itemtitlereportus') + ':'" title1="报告英文抬头" prop="report_us">
								<el-input type="text" clearable v-model="formData.report_us" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item :label="$t('itemtitlereportaddresszh') + ':'" title1="报告中文地址" prop="report_address_zh">
								<el-input type="text" clearable v-model="formData.report_address_zh" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item :label="$t('itemtitlereportaddressus') + ':'" title1="报告英文地址" prop="report_address_us">
					...
					<el-row class="main-align-items-center">
						...
						<el-col :span="24">
							<el-form-item :label="$t('columnappointmentdescription') + ':'" title1="情况说明" prop="desc39">
								<el-input type="textarea" clearable v-model="formData.desc39" :disabled="isdisabled"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item :label="$t('panelcolumnsampleRemarks') + ':'" title1="样品备注" prop="desc93">
			...
			<el-tab-pane :label="$t('itemtitletestItemPreview')" name="price" class="all-height flex-column">
				<div style="margin: 10px; text-align: left">
					...
					>
					<el-button size="small" class="button_show" v-show="itemShow" type="primary" icon="ZoomIn" @click="dialogShow('dialogShow_newItemApplintment')" plain>{{
						$t("menu_newItem")
					}}</el-button>
					<el-button size="small" class="button_show" v-show="itemShow" type="danger" icon="Delete" plain>{{
						$t("menu_deleteItem")
					}}</el-button>
					<el-button size="small" class="button_show" v-show="itemShow" type="primary" icon="ZoomIn" plain>{{
						$t("menu_chooseFolder")
					}}</el-button>
					<el-button size="small" class="button_show" v-show="submitShow" type="success" icon="Check" plain>{{
						$t("menu_submit")
...
const otherTableList = reactive({
	...
	httpAttribute: {
		...
		root: "vmaps",
		baseParams: { reservnum: "08110320220906051" }
	},
	//表格表头
	tableColumns: [
		{
...
const updateDesc95 = () => {
	...
	let v_desc95 = formData.desc95flag;
	let sv_isdefaulttax = v_isdefaulttax.replace("_", "");
	if (v_isdefaulttax.indexOf("_") > 0) {
		//有下划线说明是PKM用户
		formData1.desc64 = v_desc95;
